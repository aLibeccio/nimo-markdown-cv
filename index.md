...
- **项目名称**：资金网关
- **项目描述**：在瓜子（车好多集团）资金流有限的情况下，为了尽可能的满足用户贷款购车的需求，瓜子金融系统需要接入不同类型的资金方，所以为了实现金融系统的最小化变更的接入新资金方，需要抽象出一个统一模块即资金网关来完成对资金方的对接，由资金网关来提供向金融内部系统的资方审核、资方借款、资方还款功能。
...
- **项目职责**：
  - 富民银行、诺亚融租、民生金租等资金方全流程对接（需求评审、开发、联调测试），以及新网银行、工商银行等资金方项目需求开发迭代。
  - 负责一部分统一依赖服务的开发。
